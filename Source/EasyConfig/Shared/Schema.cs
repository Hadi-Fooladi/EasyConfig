// auto-generated by EasyConfig (v4.9.33)
...
namespace EasyConfig
{
	...
	{
		private static XmlNode GetRootNode(string Filename)
		{
		...
		public Schema(string Filename) : this(GetRootNode(Filename)) { }
	...
	internal partial class Field : VarBase
	{
		...
		/// <summary>
		/// If true, instantiate the field in the default constructor<br />
		/// Note: If 'Multiple' is 'Yes', this attribute will be discarded and the field (List) always will be instantiated in the default constructor<br />
		/// Used to prevent circular recursive instantiation
		/// </summary>
		public readonly bool Instantiate;

		public Field(XmlNode Node) : base(Node)
		{
			TagName = Node.Attr("TagName", null);
			Multiple = Node.ynAttr("Multiple", false);
			Instantiate = Node.ynAttr("Instantiate", true);
		}
	}
